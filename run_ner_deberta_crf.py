...
from transformers import WEIGHTS_NAME, get_linear_schedule_with_warmup, AdamW, DebertaV2Config, DebertaV2Tokenizer, \
    AutoTokenizer, AutoModelForMaskedLM
from models.bert_for_ner import DeBertCrfForNer
...
MODEL_CLASSES = {
    ...
    'deberta': (DebertaV2Config, DeBertCrfForNer, DebertaV2Tokenizer),
}
